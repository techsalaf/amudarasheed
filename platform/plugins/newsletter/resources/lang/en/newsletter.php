    ...
    'settings' => [
        'email' => [
            'templates' => [
                ...
                'new_post' => [
                    'title' => 'New blog post notification',
                    'description' => 'Template for sending new blog post notification to subscribers',
                    'subject' => '{{ site_title }}: New Post - {{ post_title }}',
                    'newsletter_name' => 'Full name of newsletter subscriber',
                    'newsletter_email' => 'Email of newsletter subscriber',
                    'post_title' => 'Title of the new blog post',
                    'post_excerpt' => 'Short excerpt from the blog post',
                    'post_content' => 'Full content of the blog post',
                    'post_url' => 'URL to the blog post',
                    'post_image' => 'Featured image URL of the blog post',
                    'newsletter_unsubscribe_link' => 'Link for unsubscribe newsletter',
                    'newsletter_unsubscribe_url' => 'URL for unsubscribe newsletter',
                ],
            ],
